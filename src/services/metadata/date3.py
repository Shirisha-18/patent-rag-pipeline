...
def _extract_era_b(all_lines: list) -> ExtractionResult:
    ...
    Fix 7: filing pattern accepts OCR corruptions of 'filed':
           fled / led / filled / f1led
    """
...
def _extract_era_c(all_lines: list) -> ExtractionResult:
    ...
    Fix 7: filing pattern accepts OCR corruptions of 'filed':
           fled / led / filled / f1led
           Observed in corpus: 'Application fled January 6, 1921'
                               'Application led April 1, 1915'
                               'Application filled April 16, 1912'
    """
    patented_pat = rf"[Pp]atented\s+{FLEXIBLE_DATE}"
    filing_pat = rf"[Aa]pplication\s+{_FILED_PAT}\s+{FLEXIBLE_DATE}"
